...
class Svg:
    ...
    def save(self, direction):
        self.svg = [
            ...
            f'<svg width="{self.width}" height="{self.height}"  viewbox="0 0 {self.width} {self.height}"  style="enable-background:new 0 0 {self.width} {self.height};" xml:space="preserve" x="0" y="0" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">',
            '<style type="text/css" >',
            '\n'.join(self.styles),
            '</style>',
            '\n'.join(self.objects),
